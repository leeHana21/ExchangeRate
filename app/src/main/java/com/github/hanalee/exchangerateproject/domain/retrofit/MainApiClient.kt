...
import com.github.hanalee.exchangerateproject.utils.UtilFunction.Companion.httpLoggingInterceptor
...
object MainApiClient {
    ...
    fun getInstance(): MainApiInterface {
        val builder = Retrofit.Builder().baseUrl(BuildConfig.BASE_URL).addConverterFactory(
